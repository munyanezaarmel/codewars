...
console.log(`sarah's dog is eating too ${dogsSarah.recommendedFood > dogsSarah.curFood ? "little" : "high"}`)
//3
...
//4
console.log(ownersEatTooLittle.map(dog=>dog.owners).flat())
ownersEatTooMuch.map(dog =>dog.owners).flat()
